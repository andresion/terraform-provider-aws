...
import (
	...
	"github.com/terraform-providers/terraform-provider-aws/internal/mutexkv"
...
type AWSClient struct {
	...
	CognitoIdentityProviderConn      *cognitoidentityprovider.CognitoIdentityProvider
...
func (c *Config) Client() (interface{}, error) {
	...
	client := &AWSClient{
		...
		CognitoIdentityProviderConn:      cognitoidentityprovider.New(sess.Copy(&aws.Config{Endpoint: aws.String(c.Endpoints["cognitoidp"])})),
...
var GlobalMutexKV = mutexkv.NewMutexKV()

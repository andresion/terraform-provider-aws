...
func dataSourceAwsEbsVolumeRead(d *schema.ResourceData, meta interface{}) error {
	...
	return volumeDescriptionAttributes(d, meta.(*client.AWSClient), volume)
}
...
func volumeDescriptionAttributes(d *schema.ResourceData, client *client.AWSClient, volume *ec2.Volume) error {

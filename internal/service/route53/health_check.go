...
func resourceAwsRoute53HealthCheckUpdate(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*client.AWSClient).Route53Conn
...
func resourceAwsRoute53HealthCheckRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("child_healthchecks", flex.FlattenStringList(updated.ChildHealthChecks)); err != nil {
	...
	d.Set("regions", flex.FlattenStringList(updated.Regions))

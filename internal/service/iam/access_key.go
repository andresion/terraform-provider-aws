...
import (
	...
	"github.com/terraform-providers/terraform-provider-aws/internal/encryption"
)
...
func resourceAwsIamAccessKeyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	sesSMTPPasswordV4, err := sesSmtpPasswordFromSecretKeySigV4(createResp.AccessKey.SecretAccessKey, meta.(*client.AWSClient).Region)
	if err != nil {

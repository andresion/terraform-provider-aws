...
func ResourcePlansScalingPlan() *schema.Resource {
...
func resourceAwsAutoScalingPlansScalingPlanCreate(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*client.AWSClient).AutoScalingPlansConn
...
func resourceAwsAutoScalingPlansScalingPlanRead(d *schema.ResourceData, meta interface{}) error {
	...
	scalingPlan, err := findScalingPlan(conn, d.Get("name").(string), d.Get("scaling_plan_version").(int))
	if err != nil {

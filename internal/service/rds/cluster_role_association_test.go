...
func testAccCheckAWSRDSClusterRoleAssociationExists(resourceName string, v *rds.DBClusterRole) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		dbClusterID, roleARN, err := clusterRoleAssociationParseResourceID(rs.Primary.ID)
		...
		role, err := findDBClusterRoleByDBClusterIDAndRoleARN(conn, dbClusterID, roleARN)
...
func testAccCheckAWSRDSClusterRoleAssociationDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err = findDBClusterRoleByDBClusterIDAndRoleARN(conn, dbClusterID, roleARN)

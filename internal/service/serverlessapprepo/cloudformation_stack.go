...
func resourceAwsServerlessApplicationRepositoryCloudFormationStackCreate(d *schema.ResourceData, meta interface{}) error {
	cfConn := meta.(*client.AWSClient).CloudFormationConn

	changeSet, err := createServerlessApplicationRepositoryCloudFormationChangeSet(d, meta.(*client.AWSClient))
	if err != nil {
	...
	_, err = tfcloudformation.StackCreated(cfConn, d.Id(), requestToken, d.Timeout(schema.TimeoutCreate))
	if err != nil {
...
func resourceAwsServerlessApplicationRepositoryCloudFormationStackRead(d *schema.ResourceData, meta interface{}) error {
	serverlessConn := meta.(*client.AWSClient).ServerlessAppRepoConn
	cfConn := meta.(*client.AWSClient).CloudFormationConn
...
func resourceAwsServerlessApplicationRepositoryCloudFormationStackUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	_, err = tfcloudformation.StackUpdated(cfConn, d.Id(), requestToken, d.Timeout(schema.TimeoutUpdate))
	if err != nil {
...
func resourceAwsServerlessApplicationRepositoryCloudFormationStackDelete(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*client.AWSClient).CloudFormationConn
	...
	_, err = tfcloudformation.StackDeleted(conn, d.Id(), requestToken, d.Timeout(schema.TimeoutDelete))
	if err != nil {
...
func createServerlessApplicationRepositoryCloudFormationChangeSet(d *schema.ResourceData, client *client.AWSClient) (*cloudformation.DescribeChangeSetOutput, error) {

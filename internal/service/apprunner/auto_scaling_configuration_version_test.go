...
func testSweepAppRunnerAutoScalingConfigurationVersions(region string) error {
	...
	conn := client.(*client.AWSClient).AppRunnerConn
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "status", autoScalingConfigurationStatusActive),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(otherResourceName, "status", autoScalingConfigurationStatusActive),
				),
			},
			{
